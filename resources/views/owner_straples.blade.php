    ...
    <title>إدارة أصحاب الكراجات</title>
    <!-- Favicon-->
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white " id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">إدارة أصحاب الكراجات</div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">إضافة مالك</h1>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      <td>{{ $i++ }}</td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete{{$u->id}}" data-bs-whatever="@mdo">حذف</button>
                                            <div class="modal fade" id="delete{{$u->id}}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{route('worker.destroy',$u->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#edit{{$u->id}}" data-bs-whatever="@mdo">تعديل</button>
                                            <div class="modal fade" id="edit{{$u->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel3">تعديل مالك</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <form action=" {{route('worker.update',$u->id)}} " method="post">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="mb-3">
                                                <label for="recipient-name" class="col-form-label">الاسم</label>
                                                <input type="text" class="form-control" id="recipient-name" name="name" value="{{$u->name}}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="recipient-name" class="col-form-label">الراتب</label>
                                                <input type="number" class="form-control" id="recipient-name" name="salary" value="{{$u->salary}}">
                                            </div>

                                            <div class="mb-3">
                                                <label for="recipient-name" class="col-form-label">الهاتف</label>
                                                <input type="text" class="form-control" id="recipient-name" name="phone" value="{{$u->phone}}">
                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
