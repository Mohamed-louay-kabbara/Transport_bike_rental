...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-end bg-white " id="sidebar-wrapper">
            <div class="sidebar-heading border-bottom bg-light">إدارة الكراجات</div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="exampleModalLabel">إضافة كراجة أو عرباية</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="{{route('Straples.store')}}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="my-select" class="form-control" name="type">
                                                <option>كراجة</option>
                                                <option>عرباية</option>
                                            </select>
                                        </div>
                               
                                <div class="mb-3">
                                    <label for="recipient-name" class="col-form-label">صاحب الكراجة</label>
                    ...
                    <table class="table table-bordered table-hover col-10" id="table_id">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endforeach
                                <td>
                                    <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#delete{{$s->id}}" data-bs-whatever="@mdo">حذف</button>
                                    <div class="modal fade" id="delete{{$s->id}}" tabindex="-1" aria-labelledby="exampleModalLabel2" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('Straples.destroy',$s->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                    ...
                                    <div class="modal fade" id="edit{{$s->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('Straples.update',$s->id)}}" method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="mb-3">
                                                            <label for="recipient-name" class="col-form-label">الرقم</label>
                                                            <input type="number" class="form-control" id="recipient-name" name="number" value="{{$s->number}}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="recipient-name" class="col-form-label">النوع</label>
